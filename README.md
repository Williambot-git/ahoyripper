...
| **Rip any video, anywhere.** A free, no-signup media converter that pulls video and audio from YouTube, X/Twitter, SoundCloud, TikTok, Instagram, Facebook, Vimeo, and 1850+ other platforms. |
...
- YouTube, X (Twitter), SoundCloud, TikTok, Instagram, Facebook, Vimeo + 1850+ platforms
...
AhoyRipper uses [yt-dlp](https://github.com/yt-dlp/yt-dlp) under the hood. It supports **1850+ platforms** — every site that yt-dlp can extract from works with AhoyRipper.
...
Every platform that [yt-dlp supports](https://github.com/yt-dlp/yt-dlp?tab=readme-ov-file#supported-sites) — currently 1850+ sites. The supported platforms table above lists the most popular ones.
