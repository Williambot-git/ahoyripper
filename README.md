...
| `DL_RATE_LIMIT` | `30` | Download rate limit per IP per minute. Protects the server against burst download activity. The `info` action has a separate limit of 30 requests/min — both limits are independent. |
